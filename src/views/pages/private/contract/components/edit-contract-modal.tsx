...
export function EditContractModal({
  ...
  useEffect(() => {
    setValue('companyName', contract?.ecClientName)
    setValue('companyDocument', contract?.ecClientDocument)
    setValue('responsibleName', contract?.responsibleName)
    setValue('responsibleEmail', contract?.responsibleEmail)
    setValue('responsibleDocument', contract?.responsibleDocument)
    setValue('responsiblePhone', contract?.responsibleWhatsapp)
    setValue('externalCode', contract?.externalCode)
    setValue('b3Protocol', contract?.protocol)
  }, [setValue, contract])
